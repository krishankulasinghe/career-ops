// Embeds all screenshots as base64 into the HTML guide so it works offline.
// Run: node saas/docs/embed-screenshots.mjs
import { readFileSync, writeFileSync } from 'fs';
import { join, dirname } from 'path';
import { fileURLToPath } from 'url';

const __dirname = dirname(fileURLToPath(import.meta.url));
const HTML_IN  = join(__dirname, 'user-guide.html');
const HTML_OUT = join(__dirname, 'user-guide-embedded.html');
