      ...
      <div className="row g-3">
          ...
          <div className="card mb-3">
            <div className="card-header">
              <div className="row align-items-center">
                <div className="col">
                  <h5 className="mb-0">API Key Analytics</h5>
                  <p className="text-600 fs--1 mb-0">Monitor API usage, request volume, and rate limits</p>
                </div>
                  ...
                  <div className="btn-group btn-group-sm" role="group">
                    {([6, 24, 72, 168] as const).map((h) => (
                      <button
                        key={h}
                        type="button"
                        className={`btn ${hours === h ? 'btn-primary' : 'btn-falcon-default'}`}
                        onClick={() => setHours(h)}
                      >
        ...
        <div className="col-md-4">
          <div className="card mb-3 text-center">
            <div className="card-body">
              ...
              <div className="text-600 fs--1">Total Requests (last {hours}h)</div>
            </div>
          </div>
        </div>
        <div className="col-md-4">
          <div className="card mb-3 text-center">
            <div className="card-body">
              ...
              <div className="text-600 fs--1">Current Plan Tier</div>
            </div>
          </div>
        </div>
        <div className="col-md-4">
          <div className="card mb-3 text-center">
            <div className="card-body">
              ...
              <div className="text-600 fs--1">Rate Limit (req/hour)</div>
            </div>
          </div>
        </div>
        ...
        <div className="col-12">
          <div className="card mb-3">
            ...
            <div className="card-body">
              {isLoading ? (
                <div className="text-center text-600 py-5">Loading…</div>
              ) : (
        ...
        <div className="col-12">
          <div className="card mb-3">
            <div className="card-header">
              <h5 className="mb-0">Top Endpoints</h5>
            </div>
            <div className="card-body">
              {isLoading ? (
                <div className="text-center text-600 py-5">Loading…</div>
              ) : (data?.topEndpoints?.length ?? 0) === 0 ? (
                <div className="text-center text-600 py-5">No API key requests recorded yet.</div>
              ) : (
        ...
        <div className="col-12">
          <div className="card mb-3">
            <div className="card-header">
              <h5 className="mb-0">Rate Limit Tiers</h5>
            </div>
            <div className="card-body p-0">
                ...
                <table className="table table-hover table-sm fs--1 mb-0">
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={row.plan} className={row.current ? 'bg-soft-primary' : ''}>
                        <td className="align-middle">
                          {row.plan}
                          {row.current && (
                            <span className="ms-2 badge badge-soft-primary fs--2">← your plan</span>
                          )}
                        </td>
                        <td className="align-middle">{row.limit}</td>
                        <td className="align-middle font-monospace text-600 fs--2">
              ...
              <div className="px-3 py-2 border-top fs--2 text-600">
